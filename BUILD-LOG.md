...
| KEEP-6 | 6 | city | in-flight | | `CITY` object; stamp.py checks the SQL constraints against it |
| DATA-4 | 6 | city | in-flight | | borough pages generated by a tool, after KEEP-6 |
| KEEP-4 | 6 | offline | in-flight | | `sw.js`, tested update path |
| KEEP-5 | 6 | freshness | in-flight | | stale-while-revalidate without losing view state |
